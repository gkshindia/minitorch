...
def test_unit_adamw_optimizer():
    ...
    adam = Adam([param_adam], learning_rate=0.01, weight_decay=0.01)
    adamw = AdamW([param_adamw], learning_rate=0.01, weight_decay=0.01)
    ...
    optimizer = AdamW([param], learning_rate=0.01, weight_decay=0.01)
    ...
    adam_no_wd = Adam([param1], learning_rate=0.01, weight_decay=0.0)
    adamw_no_wd = AdamW([param2], learning_rate=0.01, weight_decay=0.0)
